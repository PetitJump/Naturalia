...
SUCCES_DEF = [
    ...
    {"id": "meute_royale", "emoji": "🐺", "nom": "Meute royale",
     "desc": "Atteindre une population de 75 loups simultanément. La forêt leur appartient."},
    {"id": "troupeau",     "emoji": "🦌", "nom": "Troupeau parfait",
     "desc": "Atteindre une population de 1200 cerfs simultanément. Le troupeau est au complet."},
    {"id": "foret_dense",  "emoji": "🌿", "nom": "Forêt dense",
     "desc": "Atteindre une végétation de 7000 touffes d'herbe simultanément. La prairie est luxuriante."},
